...
class Statistics extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={`${styles.panelContainer} ${this.state.position}`}>
        <Panel>
          ...
          <Panel.Body className={styles.panelBody}>Finished <strong>{finishedItems}</strong> from <strong>{allItems}</strong>.</Panel.Body>
